...
public class HostAndPort implements Serializable {
	...
	/**
	 * 将字符串分成主机和端口部分。字符串必须是(host + ":" + port)格式。端口是可选的 <br/>
	 * 
	...
	public static HostAndPort parseString(String from) {
		...
		// '99aa9999aa9a99aa099aaa990aa99a09aa9a9999 9a09:9a9:a090:9a::99a slave 8c88888888cc08088cc8c8c888c88c8888c88cc8 0
		// 1468251272993 37 connected'
	...
	public static String convertHost(String host) {
		try {
			/*
			 * Validate the host name as an IPV4/IPV6 address. If this is an AWS ENDPOINT it will not parse. In that case accept
			 * host as is.
			 *
			 * Costs: If this is an IPV4/6 encoding, e.g. 127.0.0.1 then no DNS lookup is done. If it is a name then a DNS lookup is
			 * done but it is normally cached. Secondarily, this class is typically used to create a connection once at the
			 * beginning of processing and then not used again. So even if the DNS lookup needs to be done then the cost is
			 * miniscule.
			 */
